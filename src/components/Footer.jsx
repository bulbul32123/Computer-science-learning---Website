...
export default function Footer() {
  return (
    <footer class="w-full h-full py-28 pl-5 pr-5 md:pl-20 md:pr-20 3xl:pl-80 3xl:pr-80 mt-10 bg-darkPurple flex md:flex-row flex-col justify-between">
      <div class="w-full md:w-[45rem] text-center md:text-left">
        <h3 className='text-4xl font-semibold md:font-bold md:pr-24'>Join the Computer Science School newsletter</h3>
        <p class="my-5 text-sm">Donec et scelerisque quam. Aliquam varius et sapien.</p>
      ...
      <div class="flex max-xsm:flex-wrap gap-9 md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
        <div class="lg:w-1/4 md:w-1/2 w-full">
          <h2 class="font-bold tracking-widest text-lg mb-3">Learn</h2>
          <nav class="list-none mb-10 flex gap-4 flex-col">
            {
        ...
        <div class="lg:w-1/4 md:w-1/2 w-full">
          <h2 class="font-bold tracking-widest text-lg mb-3">Company</h2>
          <nav class="list-none mb-10 flex gap-4 flex-col">
            {
